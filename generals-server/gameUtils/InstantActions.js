...
export const notifySound_lostCastle = (socketId) => io.to(socketId).emit('sound_lostCastle')
export const notifySound_archeryShooted = (socketId) => io.to(socketId).emit('sound_archeryShooted')
export const notifySound_capitolAttacked = (socketId) => io.to(socketId).emit('sound_capitolAttack')